...
def show_posts():
    clear()
    banner()
    print(GREEN + BOLD + "╔" + line("═", 62) + "╗")
    print("║" + "              PUBLICATIONS".center(62) + "║")
    print("╚" + line("═", 62) + "╝" + RESET)
    ...
    for post in data:
        ...
        print(CYAN + "  ┌─ INFO " + "─" * 53 + RESET)
        for text in post["info"].replace("\r", "").split("\n"):
            print(WHITE + "  │ " + text[:100] + RESET)
        print(CYAN + "  └" + "─" * 61 + RESET)
...
def publish():
    clear()
    banner()
    print(MAGENTA + BOLD + "╔" + line("═", 62) + "╗")
    print("║" + "             NOUVELLE PUBLICATION".center(62) + "║")
    print("╚" + line("═", 62) + "╝" + RESET)
